@extends('dashboard.layouts.main', ['title' => 'Edit | Pembelajaran -'])
...
@section('container')
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="card card-custom card-create">
            <div class="card-body">
                <form action="{{ url('dashboard/pembelajaran/' . $pembelajaran->id) }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group">
                                <input type="text" placeholder="Nama Pembelajaran" name="nama_pembelajaran"
                                    ...
                                    value="{{ $pembelajaran->nama_pembelajaran }}" class="form-control">
                            ...
                            <select class="form-select" data-control="select2" data-placeholder="Select an option"
                                ...
                                @foreach ($pelatihs as $pelatih)
                                    <option value="{{ $pelatih->id }}"
                                        {{ $pelatih->id == $pembelajaran->pelatih_id ? 'selected' : '' }}>
                                        {{ $pelatih->nama_pelatih }}</option>
                                @endforeach
                            </select>
                            @error('pelatih_id')
                                <div class="invalid-feedback d-block">
                            ...
                            <select class="form-select" data-control="select2" data-placeholder="Select an option"
                                ...
                                @foreach ($kategoris as $kategori)
                                    <option value="{{ $kategori->id }}"
                                        {{ $kategori->id == $pembelajaran->kategori_id ? 'selected' : '' }}>
                        ...
                        <div class="form-group col-md-8">
                            ...
                            <div class="input-group">
                                ...
                                <input type="integer" placeholder="tarif" name="tarif" required="required"
                                    ...
                                    class="form-control" value="{{ $pembelajaran->tarif }}">
                                @error('tarif')
                                    <div class="invalid-feedback d-block">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" placeholder="diskon" name="diskon" @error('diskon')is-invalid @enderror
                                class="form-control" value="{{ $pembelajaran->diskon }}">
                            @error('diskon')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea type="textarea" placeholder="deskripsi" name="deskripsi" id="deskripsi"
                                @error('deskripsi')is-invalid @enderror class="form-control" value="0 ">{{ $pembelajaran->deskripsi }}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
