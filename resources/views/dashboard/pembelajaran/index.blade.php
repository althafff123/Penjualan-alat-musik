@extends('dashboard.layouts.main', ['title' => 'Pembelajaran -'])
                ...
                <div class="card card-flush">
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        <div class="card-toolbar">
                            <a href="{{ url('dashboard/pembelajaran/create') }}" class="btn btn-primary"> <i
                                    class="fa fa-plus">
                                </i> Tambah</a>
                        ...
                        <div class="card-title">
                            <form method="GET" action="{{ url('dashboard/pembelajaran/') }}" autocomplete="off">
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" name="keyword" data-kt-ecommerce-category-filter="search"
                                        ...
                                        placeholder="Search Pembelajaran" value="{{ $keyword }}">
                                </div>
                            </form>
                        </div>
                    </div>
                                    ...
                                    <thead>
                                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="kt_ecommerce_category_table"
                                                rowspan="1" colspan="1"
                                                aria-label="Category: activate to sort column ascending">Nama Pembelajaran
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="kt_ecommerce_category_table"
                                                rowspan="1" colspan="1"
                                                aria-label="Category: activate to sort column ascending">Foto Pelatih</th>
                                            <th class="sorting" tabindex="0" aria-controls="kt_ecommerce_category_table"
                                                rowspan="1" colspan="1"
                                                aria-label="Category: activate to sort column ascending">Nama Pelatih</th>
                                            <th class="sorting" tabindex="0" aria-controls="kt_ecommerce_category_table"
                                                rowspan="1" colspan="1"
                                            ...
                                            <th class="sorting" tabindex="0"
                                                aria-controls="kt_ecommerce_category_table" rowspan="1" colspan="1"
                                                aria-label="Category: activate to sort column ascending">Tarif</th>
                                            <th class="sorting" tabindex="0"
                                                aria-controls="kt_ecommerce_category_table" rowspan="1" colspan="1"
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <img src="{{ asset('storage/' . $value->pelatih->foto) }}"
                                                            alt="" width="100px">
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1">
                                                            {{ $value->pelatih->nama_pelatih }}</div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1">
                                                            {{ number_format($value->tarif, 0, ',', '.') }}</div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-end">
                                                    <a class="btn btn-sm btn-icon btn-light-primary mb-2 edit"
                                                        href="{{ url('dashboard/pembelajaran/' . $value->id . '/edit') }}"
                                                        title="Edit">
    ...
    <script>
        $('table').on('click', '.hapus', function() {
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url: '{{ url('dashboard/pembelajaran') }}/' + id,
                        method: 'POST',
                        headers: {
