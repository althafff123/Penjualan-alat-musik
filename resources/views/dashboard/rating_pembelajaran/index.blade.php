@extends('dashboard.layouts.main', ['title' => 'Rating Pembelajaran -'])
@section('style')
    <style>
        .rating {
            margin-top: 40px;
                ...
                <div class="card card-flush">
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        <div class="card-title">
                            <form method="GET" action="{{ url('dashboard/rating_pembelajaran/') }}">
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" name="keyword" data-kt-ecommerce-category-filter="search"
                                        ...
                                        placeholder="Search Rating Pembelajaran" value="{{ $keyword }}">
                                </div>
                            </form>
                        </div>
                    </div>
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                    ...
                                    <thead>
                                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="kt_ecommerce_category_table"
                                                rowspan="1" colspan="1"
                                                aria-label="Category Type: activate to sort column ascending">Nama
                                                Pembelajaran
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="kt_ecommerce_category_table"
                                                rowspan="1" colspan="1"
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        @foreach ($rating_pembelajaran as $key => $value)
                                            <tr class="odd">
                                                <td>
                                                    <div
                                                        class="form-check form-check-sm form-check-custom form-check-solid">
                                                        {{ $rating_pembelajaran->firstItem() + $key }}
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1">
                                                            {{ $value->pembelajaran->nama_pembelajaran }}</div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex">
                                                ...
                                                <td class="text-end">
                                                    <a class="btn btn-sm btn-icon btn-light-info mb-2 edit"
                                                        href="{{ url('dashboard/rating_pembelajaran/' . $value->id . '/edit') }}"
                                                        title="Edit">
