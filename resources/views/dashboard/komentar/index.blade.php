@extends('dashboard.layouts.main', ['title' => 'Komentar -'])
                ...
                <div class="card card-flush">
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        <div class="card-title">
                            <form method="GET" action="{{ url('dashboard/komentar/') }}">
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td class="text-end">
                                                    <a class="btn btn-sm btn-icon btn-light-info mb-2 edit"
                                                        href="{{ url('dashboard/komentar/' . $value->id . '/edit') }}"
                                                        title="Edit">
