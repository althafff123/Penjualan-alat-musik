@extends('dashboard.layouts.main', ['title' => 'Edit | Pelatih -'])
...
@section('container')
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="card card-custom card-create">
            <div class="card-body">
                <form action="{{ url('dashboard/pelatih/' . $pelatih->id) }}" method="POST" enctype="multipart/form-data"
                    autocomplete="off">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="text" placeholder="pelatih" name="nama_pelatih" required="required"
                                    value="{{ $pelatih->nama_pelatih }}" @error('nama_pelatih')is-invalid @enderror
                                    class="form-control">
                                @error('nama_pelatih')
                        ...
                        <div class="col-md-4">
                            <div class="mb-4">
                                ...
                                <div class="image-input image-input-empty" data-kt-image-input="true"
                                    style="background-image: url('{{ asset('storage/' . $pelatih->foto) }}')">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea type="textarea" placeholder="deskripsi" name="deskripsi" id="deskripsi"
                                @error('deskripsi')is-invalid @enderror class="form-control" value="0">{!! $pelatih->deskripsi !!}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
