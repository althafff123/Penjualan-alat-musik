@extends('dashboard.layouts.main', ['title' => 'Edit | Barang -'])
...
@section('container')
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="card card-custom card-create">
            <div class="card-body">
                <form action="{{ url('dashboard/barang/' . $barang->id) }}" method="POST" enctype="multipart/form-data"
                    autocomplete="off">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="number" placeholder="stock" name="stock" required="required" min="0"
                                    @error('stock')is-invalid @enderror class="form-control" value="{{ $barang->stock }}">
                                @error('stock')
                                    <div class="invalid-feedback d-block">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-4">
                                ...
                                <div class="image-input image-input-empty" data-kt-image-input="true"
                                    style="background-image:  url('{{ asset('storage/' . $barang->foto) }}')">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" placeholder="diskon" name="diskon"
                                        @error('diskon')is-invalid @enderror class="form-control"
                                        value="{{ $barang->diskon }}">
                                    @error('diskon')
                                        <div class="invalid-feedback d-block">
                                            {{ $message }}
                        ...
                        <div class="col-md-15">
                            ...
                            <textarea type="textarea" placeholder="deskripsi" name="deskripsi" id="deskripsi"
                                @error('deskripsi')is-invalid @enderror class="form-control">{{ $barang->deskripsi }}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="integer" placeholder="harga" name="harga" required="required"
                                ...
                                class="form-control" value="{{ $barang->harga }}">
                            @error('harga')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
