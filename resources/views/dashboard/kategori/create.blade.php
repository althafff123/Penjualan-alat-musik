@extends('dashboard.layouts.main', ['title' => 'Create | Kategori -'])
...
@section('container')
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="card card-custom card-create">
            <div class="card-body">
                <form action="{{ url('dashboard/kategori') }}" method="POST" autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-4">
                                ...
                                <input type="text" placeholder="Kategori" name="nama_kategori" required="required"
                                    @error('nama_kategori')is-invalid @enderror class="form-control">
                                @error('nama_kategori')
