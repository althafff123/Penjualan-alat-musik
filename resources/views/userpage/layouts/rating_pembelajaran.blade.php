@extends('userpage.layouts.main', ['sub' => true], ['title' => 'Rating Pembelajaran'])
    ...
    <section class="book_section layout_padding">
        <div class="container">
            <div class="body">
                <div class="row">
                    <div class="col-md-2">
                        <img src="{{ asset('storage/' . $pembelajaran->pelatih->foto) }}" class="img-fluid" width="400px">
                    </div>
                    <div class="col-md-10">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-floating">
                                        ...
                                        <div class="star-rating mt-5">
                                            <input id="star-5" type="radio" name="rating" value="5"
                                                {{ @$rating_pembelajaran->rating == 5 ? 'checked' : '' }} />
                                            <label for="star-5" title="Sangat Bagus">
                                                <i class="active fa fa-star" aria-hidden="true"></i>
                                            </label>
                                            <input id="star-4" type="radio" name="rating" value="4"
                                                {{ @$rating_pembelajaran->rating == 4 ? 'checked' : '' }} />
                                            <label for="star-4" title="Cukup Bagus">
                                                <i class="active fa fa-star" aria-hidden="true"></i>
                                            </label>
                                            <input id="star-3" type="radio" name="rating" value="3"
                                                {{ @$rating_pembelajaran->rating == 3 ? 'checked' : '' }} />
                                            <label for="star-3" title="Bagus">
                                                <i class="active fa fa-star" aria-hidden="true"></i>
                                            </label>
                                            <input id="star-2" type="radio" name="rating" value="2"
                                                {{ @$rating_pembelajaran->rating == 2 ? 'checked' : '' }} />
                                            <label for="star-2" title="Cukup Jelek">
                                                <i class="active fa fa-star" aria-hidden="true"></i>
                                            </label>
                                            <input id="star-1" type="radio" name="rating" value="1"
                                                {{ @$rating_pembelajaran->rating == 1 ? 'checked' : '' }} />
                                ...
                                <div class="col-md-12 mt-3">
                                    <textarea type="textarea" placeholder="Berikan Komentar" name="komentar" class="form-control" value="0 "
                                        rows="5">{{ @$rating_pembelajaran->komentar }}</textarea>
                                    @error('komentar')
